...
/** Every vehicle, ARCHIVED ONES INCLUDED -- the read path for Notifications/Archive, which must see archived records too (see features/archive/, features/notifications/). */
...
/** Non-archived -- the normal active Vehicles list. Centralized here so no component ever filters `archivedAt` itself. */
